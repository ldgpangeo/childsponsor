...
#    include_once("../../lib/r_payment_tools.php");
    ...
    $start_semi     = strftime('%F', mktime('0','0','0',(month - 6), '1', $year) );
    $start_quarter  = strftime('%F', mktime('0','0','0',(month - 3), '1', $year) );
    $end_date       = strftime('%F', mktime('0','0','0',(month +4), '-1', $year) );
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        if ( ($tmppmt >= strtotime($start)) and ($tmppmt <= time()) ) {
